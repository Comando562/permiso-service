...
public class PermisoServiceImpl implements  IPermisoService {
     ...
     * @return a response entity of the list of the Permiso object.
     */
    //public ResponseEntity<List<PermisoDTO>> listAll() {: Esta es la declaración de un método público llamado listAll
    // que devuelve un ResponseEntity que contiene una lista de objetos PermisoDTO.
